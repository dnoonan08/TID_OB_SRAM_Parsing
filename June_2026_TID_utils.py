...
_xray_times = {
    'COB-10Pct-4-1':{
        'Starttime':np.datetime64('2026-06-09 12:00'),
        'Cooldown' :np.datetime64('2026-06-09 13:37'),
        'Xray 10'  :np.datetime64('2026-06-09 17:12'),
        'Xray 50'  :np.datetime64('2026-06-10 11:28'),
        'Xray Off' :np.datetime64('2026-06-10 11:28'),
        },
    'COB-10Pct-5-3':{
        'Starttime':np.datetime64('2026-06-10 12:00'),
        'Cooldown' :np.datetime64('2026-06-10 15:36'),
        'Xray 10'  :np.datetime64('2026-06-10 16:51'),
        'Xray 50'  :np.datetime64('2026-06-11 10:05'),
        'Xray Off' :np.datetime64('2026-06-11 10:05'),
        },
    'COB-10Pct-6-1':{
        'Starttime':np.datetime64('2026-06-11 12:00'),
        'Cooldown' :np.datetime64('2026-06-11 14:22'),
        'Xray 10'  :np.datetime64('2026-06-11 15:39'),
        'Xray 50'  :np.datetime64('2026-06-13 12:10'),
        'Xray Off' :np.datetime64('2026-06-13 12:10'),
        },
    'COB-10Pct-4-2':{
        'Starttime':np.datetime64('2026-06-13 12:00'),
        'Cooldown' :np.datetime64('2026-06-13 14:02'),
        'Xray 10'  :np.datetime64('2026-06-13 15:40'),
        'Xray 50'  :np.datetime64('2026-06-15 08:00'),
        'Xray Off' :np.datetime64('2026-06-15 08:00'),
        },
    }
...
def loadData(_COB_,filePath='/eos/user/d/dnoonan/June_2026_TID_Data/parsed_data'):
    d_tot_list = []
    d_bist_list = []
    d_packets_list = []
    d_settings_list = []
